...
class Foodrev extends StatefulWidget {
  const Foodrev({super.key});

  @override
  State<Foodrev> createState() => _FoodrevState();
}

class _FoodrevState extends State<Foodrev> {
  ...
  List<String> catnames = ["Fast Food", "Fine Dine"];
  List<String> assetnames = ["food.png", "finedine.png"];
            ...
            return ListView(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: AdvancedSearch(
                      ...
                      fontSize: 14,
                      borderRadius: 10.0,
                      hintText: 'Search for food brands..',
                ...
                Padding(
                  ...
                  child: Material(
                      child: Container(
                          decoration: BoxDecoration(color: HexColor("F7F5F2")),
                          child: GridView.count(
                              crossAxisSpacing: cts.maxWidth * 0.05,
                              mainAxisSpacing: cts.maxHeight * 0.02,
                              crossAxisCount: 2,
                      ...
                      children: <Widget>[
                        Material(
                          ...
                          child: Container(
                            ...
                            child: Align(
                              alignment: Alignment.bottomCenter,
                              child: Image.asset("assets/two/food/pub.png",
                                  height: height * 0.2),
                            ),
                          ),
                        ),
