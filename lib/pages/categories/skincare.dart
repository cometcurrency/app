...
class Skincarerev extends StatefulWidget {
  const Skincarerev({super.key});

  @override
  State<Skincarerev> createState() => _SkincarerevState();
}

class _SkincarerevState extends State<Skincarerev> {
  ...
  List<String> catnames = ["Men", "Women"];
  List<String> assetnames = ["men.png", "women.png"];
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: AdvancedSearch(
                      ...
                      fontSize: 14,
                      borderRadius: 10.0,
                      hintText: 'Search for skincare brands..',
