...
class Haircarerev extends StatefulWidget {
  const Haircarerev({super.key});

  @override
  State<Haircarerev> createState() => _HaircarerevState();
}

class _HaircarerevState extends State<Haircarerev> {
  ...
  List<String> catnames = ["Haircare", "Spa"];
  List<String> assetnames = ["haircare.png", "spa.png"];
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: AdvancedSearch(
                      ...
                      fontSize: 14,
                      borderRadius: 10.0,
                      hintText: 'Search for haircare brands..',
