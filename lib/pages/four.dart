...
class _TranpageState extends State<Tranpage> {
  ...
  Widget build(BuildContext context) {
    ...
    // 'May 18 2024'
    // ];
    List<String> transamount = ['₹2000', '₹5000', '₹500', '₹2000', '₹10000'];
          ...
          Column(
            children: <Widget>[
              ...
              Stack(
                children: [
                  Container(
                    child: Image.asset("assets/tranpage/cardtran.png"),
                  ),
                  Positioned(
                      top: height * 0.09,
                      left: width * 0.35,
                      child: Container(
                        ...
                        child: Center(
                          ...
                          "$balance",
                          style: GoogleFonts.nunitoSans(
                              color: HexColor("390042"), fontSize: 20),
                        )),
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      ...
                                      Padding(
                                          padding: EdgeInsets.only(
                                              left: 50, right: 10),
                                          child: (transtype[index] ==
                                                      'Received From' ||
                                                  transtype[index] ==
                                                      'Deposited From')
                                              ? Text("+" + transamount[index],
                                                  style: GoogleFonts.nunitoSans(
                                                      color:
                                                          HexColor("03A41D")))
                                              : Text("-" + transamount[index],
