...
import 'package:maincomet/main.dart';
...
class FormRevScreen extends StatefulWidget {
  const FormRevScreen({super.key});

  @override
  State<FormRevScreen> createState() => _FormRevScreenState();
}

class _FormRevScreenState extends State<FormRevScreen> {
                        ...
                        Form(
                          ...
                          child: Column(
                            children: <Widget>[
                                      ...
                                      decoration: InputDecoration(
                                          ...
                                          enabledBorder: OutlineInputBorder(
                                              ...
                                              borderRadius:
                                                  BorderRadius.circular(10))),
                                      validator: (value) =>
                                          SimpleValidations.nameValidator(
                                              value),
                                    ),
                                  ),
                                ),
                                      ...
                                      decoration: InputDecoration(
                                          ...
                                          enabledBorder: OutlineInputBorder(
                                              ...
                                              borderRadius:
                                                  BorderRadius.circular(10))),
                                      validator: (value) =>
                                          SimpleValidations.emailValidator(
                                              value),
                                    ),
                                  ),
                                ),
                              ...
                              // BorderRadius.circular(10))),
                              // validator: (value) =>
                              // SimpleValidations.panCardValidator(
                              // value),
                              // ),
                              // ),
                              // ),
