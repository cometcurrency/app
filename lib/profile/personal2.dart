...
class Personal2 extends StatefulWidget {
  const Personal2({super.key});

  @override
  State<Personal2> createState() => _Personal2State();
}

class _Personal2State extends State<Personal2> {
                  ...
                  children: [
                    Container(
                        ...
                        child: Form(
                          ...
                          child: TextFormField(
                            validator: (value) =>
                                SimpleValidations.emptyFieldValidator(value),
                            controller: instacontroller,
                            decoration: InputDecoration(
                                enabledBorder: UnderlineInputBorder(
                                  borderSide: BorderSide(
